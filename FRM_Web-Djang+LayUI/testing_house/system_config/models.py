...
#  TODO  U8账套表
class U8_base_info(models.Model):
    user_name  =models.ForeignKey(User,to_field='user_name', on_delete=models.CASCADE,
                                  db_column='user_name_id')
    u8_install_path = models.CharField(max_length=100, null=True )
    u8_account_books = models.CharField(max_length=100, null=True )
    u8_operator = models.CharField(max_length=100, null=True )
    u8_password = models.CharField(max_length=100, null=True )
    u8_operator_date = models.CharField(max_length=100, null=True)

    def __str__(self):
        pass
    class Meta:
        db_table = 'u8_base_info'
        verbose_name_plural = 'U8基础信息'
