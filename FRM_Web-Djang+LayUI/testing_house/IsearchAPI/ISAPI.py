...
if __name__ == '__main__':
    ...
    '''
    # rpa_rest(host='http://rpa.chinaive.com', rest_type='get-process', data_json={"proc_code":""},
    ...
    '''
    # rpa_rest(host='http://rpa.chinaive.com', rest_type='get-robots', data_json={"robot_no": ""},
    #          add_pr='/rapi/rcall.action?', token='9f9d7e7a928a4873ae6191f5386b4288')
    # #
    '''
    获取队列
    ...
    rpa_rest(host='http://rpa.chinaive.com', rest_type='start-job', data_json={"proc_code":"purchase_requisition_RPA_2", "agent_no": ""},
             add_pr='/rapi/rcall.action?', token='9f9d7e7a928a4873ae6191f5386b4288')
    ...
    # '''
    # rpa_rest(host='http://rpa.chinaive.com', rest_type='get-jobs', data_json={"proc_code": "purchase_requisition_RPA_2"},
    #      add_pr='/rapi/rcall.action?', token='9f9d7e7a928a4873ae6191f5386b4288')
